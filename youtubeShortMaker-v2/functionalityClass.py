...
class videoFunctions:
        ...
        try:
            ...
            with smtplib.SMTP('smtp.gmail.com', 587) as server:
                ...
                for video_path in video_paths:
                    # Create a multipart message for each video
    ...
    def download_yourself(self,query):
        pi.download(query, limit=6)
    ...
    def titleBar(self,bg_color="yellow",text_color="black",fontSize=2,thickness=3):
        #Extract title text
    ...
    def textOnVideo(self,title,reverse):
        ...
        with open('createdVids.txt','a') as f:
